...
const BUNDLE_PLANS = [
  {
    ...
    modules: ['POS System', 'QR Menu & Table Ordering'],
    users: 2,
    branches: 1,
    yearly: 5999,
    lifetime: 22999,
  ...
  },
  {
    ...
    features: [
      ...
      'Restaurant floor plan & reservations',
      'GST-ready reports',
      'Excel / PDF export',
      'WhatsApp alerts (5,000/mo)',
      'SMS alerts (5,000/mo)',
  ...
  },
  {
    ...
    features: [
      ...
      'E-invoice ready',
      'Captain order Android app',
      'Stock audit app',
      'WhatsApp alerts (10,000/mo)',
  ...
  },
  {
    ...
    features: [
      ...
      'WhatsApp alerts (25,000/mo)',
      'SMS alerts (25,000/mo)',
...
const MODULE_PRICING = [
  ...
  { name: 'QR Menu & Ordering', icon: '📲', yearly: 2499, lifetime: 9999, renewal: 999 },
...
const ADDONS = [
  ...
  { name: '5,000 WhatsApp Messages', yearly: '₹2,000 (one-time)', lifetime: '' },
  { name: '10,000 WhatsApp Messages', yearly: '₹3,500 (one-time)', lifetime: '' },
  { name: '10,000 SMS', yearly: '₹1,500 (one-time)', lifetime: '' },
  { name: 'Custom Domain — QR Menu', yearly: '₹2,000/yr', lifetime: '' },
  { name: 'Payment Gateway Setup', yearly: '₹5,000 (one-time)', lifetime: '' },
  { name: 'Captain Order Android App', yearly: '₹1,500/yr', lifetime: '₹5,000' },
]
...
const FAQS = [
  ...
  },
  {
    ...
    a: 'Fully cloud-hosted on our infrastructure (Supabase DB + Render backend). You just need a browser or the desktop app. No server setup needed.',
  },
  {
